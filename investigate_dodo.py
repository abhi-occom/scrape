...
investigate_dodo.py
-------------------
Diagnostic script: dump the HTML structure from Dodo's NBN plans page
https://www.dodo.com/nbn  — mirrors the pattern of probe_iprimus2.py.
...
def investigate(url: str):
    ...
    with sync_playwright() as p:
        ...
        # Try every hit selector to find the most card-like container
        print(f"\n{'='*70}")
